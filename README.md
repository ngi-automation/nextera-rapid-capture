...
- Consumables
   - Eppendorf twin.tec 96 PCR plate[^twintec]
   - Nunc deepwell 1.3 mL plate[^nunc]
   - ABgene 2.2 mL storage plate Mk.II[^abgene]
- Deepwell plate adaptor on position 6[^adaptor] and supporting device file
- Labware definitions*
...
[^twintec]: Eppendorf, cat# 0030 128.672 (int); 951020460 (US)

[^nunc]: Thermo Scientific, cat# 260251

[^abgene]: Thermo Scientific, cat# # AB-0933

[^adaptor]: Agilent Technologies, cat# G5498B#012
